...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        drawing_key_points[10] = drawing_key_points[4] + self.convert_meters_to_pixels(
            constants.DOUBLE_ALLEY_DIFFERENCE)
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points, yolo=True):
        player_heights = {
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                frame_index_min = max(10, frame_num - 20)
